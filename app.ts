      ...
      const response = await ai.models.generateContent({
        ...
        config: {
          ...
          responseSchema: {
            ...
            required: ["fitScore", "sizeRecommendation", "sizeConfidence", "bodyType", "skinToneMatch", "measurementsEstimate", "imagQualityNote", "stylingTips", "fitterAnalysis", "aestheticVerdict"],
          },
        },
      });
